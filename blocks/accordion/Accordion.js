...
export class Accordion {
  ...
  openDefaultItemByClass() {
    const openItem = Array.prototype.find.call(this.itemList, item =>
      item.classList.contains(this.params.classes.initialItem)
    )
  ...
  destroy() {
    ...
    this.itemList.forEach(item => item.classList.remove(this.classes.opened))
  }
